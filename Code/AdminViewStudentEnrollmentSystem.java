...
public class AdminViewStudentEnrollmentSystem extends JPanel {
    ...
    public AdminViewStudentEnrollmentSystem(JFrame parentFrame,SystemFacade facade) {
        setSize(800, 600);
    ...
    private void displayEnrollmentDetails(String studentID) {
        ...
        JLabel programTakenLabel= new JLabel("Program Taken: "+student.getProgramType());
        studentEnrollmentPanel.add(programTakenLabel);
