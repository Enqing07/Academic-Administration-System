...
public class AdminEnrollmentSystem extends JPanel {
    ...
    public AdminEnrollmentSystem(JFrame parentFrame,SystemFacade facade) {
        ...
        // Student ID
        studentIDField = addLabelAndField(mainPanel, gbc, "Student ID:", studentIDField, 1);

        // Student Name
        studentNameField = addLabelAndField(mainPanel, gbc, "Student Name:", studentNameField, 2);

        // Contact Number
        contactField = addLabelAndField(mainPanel, gbc, "Contact Number:", contactField, 3);
        ...
        submitButton.addActionListener(e -> {
            ...
            if (!studentIDField.getText().isEmpty() &&
                ...
                String enrolledCourses = enrollSelectedCourses();
                JOptionPane.showMessageDialog(this, "Enrolled in: " + enrolledCourses, "Success",
    ...
    private JTextField addLabelAndField(JPanel panel, GridBagConstraints gbc, String labelText, JTextField textField,
            int yPos) {
    ...
    private String enrollSelectedCourses() {
        ...
        for (JComboBox<String> subjectList : subjectLists) {
            ...
            if (selectedCourseName != null) {
                ...
                if (!selectedCoursesString.isEmpty()) {
                    selectedCoursesString += ", ";
                }
                selectedCoursesString += selectedCourseName;
            }
        }
        return selectedCoursesString;
    }
    ...
    private void submitRegistration() {
        ...
        if (Enroll.findStudentID(studentID)) {
            JOptionPane.showMessageDialog(this, "Student ID is already taken.", "Error", JOptionPane.ERROR_MESSAGE);
